...
-ifndef(HIPE_AMD64_POSTPASS).
-define(HIPE_AMD64_POSTPASS, hipe_amd64_postpass).
-endif.

%%%%%%%%%%%
%Below this points is code that has not yet been reviewed.
%%%%%%%%%%%

-module(?HIPE_AMD64_POSTPASS).
-export([postpass/2]).
%-include("../amd64/hipe_amd64.hrl").

%%>----------------------------------------------------------------------<
%  Procedure : postpass/2
%  Purpose   : Function that performs a number of postpass optimizations on
